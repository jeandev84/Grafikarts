   ...
   */
    ...
    */
    public function map($method, $path, $callable, $name = null)
    {
        ...
        # permet d'appeler le callable string comme un nom de route
        # example $router->url('PostController@show') renvera /posts/:id
        # example $router->url('posts/index.php')   /posts/index.php
        if(is_string($callable) && $name === null)
        {
            $name = $callable;
        }

        # enregistrer les routes nommes
        if($name)
        {
